...
pasta = "NS_c_h_V_08_rmin01_v_100/"
...
V = (0.8) * delta  # want the fluid to occupy 1/3 of the domain
...
def resp_direto(rho):
    ...
    solver_direto = NonlinearVariationalSolver(problem)
    # Newton-Kantorovich method parameters
    PRM = solver_direto.parameters["newton_solver"]
    PRM["linear_solver"] =          "default" #ao inves de mumps
    #PRM["method"] =             "full"
