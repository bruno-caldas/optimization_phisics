...
t = Function(T)
t = resp_direto(m,"problema_direto_inicial")

#Limites e restricao de volume
lb = 0.0
ub = 1.0
volume_constraint = UFLEqualityConstraint((0.25 - m)*dx, Control(m))

# Montando Funcional
J = assemble((t*t+beta*((m**2)*(1-m)**2))*dx)
